<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmBlogGrid.aspx.cs" Inherits="CampaniaElectoral.frmBlogGrid" %>
		...
		<div class="col-md-12">
			...
			<div class="panel panel-white">
				<div class="panel-heading">
					<h4 class="panel-title">Catálogo <span class="text-bold">Publicaciones Blog</span></h4>
				</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-md-12 space20">
							<a href="frmBlog.aspx" class="btn btn-green">
								Nuevo
								...
								<tr>
									...
									<td>
										<div class="visible-md visible-lg hidden-sm hidden-xs">
											<%Response.Write("<a href='frmBlog.aspx?op=2&id=" + Item.IDPublicacion.ToString() + "' class='btn btn-xs btn-blue tooltips' data-placement='top' data-original-title='Editar'> <i class='fa fa-edit'> </i> </a>"); %>
										...
										<div class="visible-xs visible-sm hidden-md hidden-lg">
											<div class="btn-group">
												...
												<ul role="menu" class="dropdown-menu pull-right dropdown-dark">
													<li>
														<%Response.Write("<a href='frmBlog.aspx?op=2&id=" + Item.IDPublicacion.ToString() + "' role='menuitem' tabindex='-1' class='tooltips' data-placement='top' data-original-title='Editar'><i class='fa fa-edit'></i>Editar</a>"); %>
													</li>
													<li>
										...
										<div class="modal-dialog modal-sm">
											<div class="modal-content">
												...
												<div class="modal-footer">                     
													...
													<% Response.Write("<a  href='frmBlogGrid.aspx?op=3&id=" + Item.IDPublicacion.ToString() + "' class='btn btn-green add-row' runat='server'>Si</a>");%>                                           
												</div>
											</div>
										</div>
									  </div>
