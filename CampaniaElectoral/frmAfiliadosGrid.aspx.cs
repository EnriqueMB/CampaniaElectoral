    ...
    public partial class frmAfiliadosGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (Request.QueryString["op"] != null && Request.QueryString["op"] == "6")
                {
                    if (Request.QueryString["id"] != null)
                    {
                        string AuxID = Request.QueryString["id"];
                ...
                else if (Request.QueryString["op"] != null && Request.QueryString["op"] == "7")
                {
                    if (Request.QueryString["id"] != null)
                    {
                ...
                if (Request.QueryString["op"] != null && Request.QueryString["op"] == "11")
                {
                    if (Request.QueryString["Buscar"] != null)
                    {
                        int OP = 0;
                ...
                if (Request.QueryString["op"] != null && Request.QueryString["op"] == "12")
                {
                    if (Request.QueryString["Buscar"] != null)
                    {
                        int OP = 0;
                ...
                if (Request.QueryString["op"] != null && Request.QueryString["op"] == "13")
                {
                    if (Request.QueryString["Buscar"] != null)
                    {
                        int OP = 0;
