<%@ Page Language="C#" Title="Catálogo de Auxiliar" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmAuxiliarGrid.aspx.cs" Inherits="CampaniaElectoral.frmAuxiliarGrid" %>
	    ...
	    <div class="col-md-12">
		    ...
		    <div class="panel panel-white">
			    <div class="panel-heading">
				    <h4 class="panel-title"><span class="text-bold">Auxiliar</span></h4>
				</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-md-12 space20">
                            <a href="frmNuevoAuxiliar.aspx" class="btn btn-green">
                                Nuevo
								...
								<tr>
                                    ...
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs">
                                            <%Response.Write("<a href='frmNuevoAuxiliar.aspx?op=2&id=" + Item.IDColaborador.ToString() + "' class='btn btn-xs btn-blue tooltips' data-placement='top' data-original-title='Editar'> <i class='fa fa-edit'> </i> </a>"); %>
										...
										<div class="visible-xs visible-sm hidden-md hidden-lg">
											<div class="btn-group">
												...
												<ul role="menu" class="dropdown-menu pull-right dropdown-dark">
													<li>
                                                        <%Response.Write("<a href='frmNuevoAuxiliar.aspx?op=2&id=" + Item.IDColaborador.ToString() + "' role='menuitem' tabindex='-1' class='tooltips' data-placement='top' data-original-title='Editar'><i class='fa fa-edit'></i>Editar</a>"); %>
													</li>
													<li>
		                                    ...
		                                    <div class="modal-content">
			                                    ...
			                                    <div class="modal-footer">                     
				                                    <button data-dismiss="modal" class="btn btn-red" type="button">No</button>
                                                      <%
                                                         Response.Write("<a  href='frmAuxiliarGrid.aspx?op=3&id=" + Item.IDColaborador.ToString() + "' class='btn btn-green add-row' runat='server'>Si</a>");
                                                      %>
			                                    </div>
		                                    </div>
		                                    <!-- /.modal-content -->
