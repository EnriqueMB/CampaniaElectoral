<%@ Page Language="C#" Title="Catálogo de status Eventos" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmStatusEventos.aspx.cs" Inherits="CampaniaElectoral.frmStatusEventos" %>
				...
				<div class="panel-body">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<span class="input-icon">
									<input type="text" class="form-control tooltips" runat="server" id="txtDescripcion" name="txtDescripcion" placeholder="" maxlength="150" data-original-title="Ingrese un status de eventos" data-rel="tooltip"  title="" data-placement="top" />
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<div class="col-md-6">
									<input type="submit" formaction="frmStatusEventos.aspx" class="btn btn-green btn-block" name ="btnGuardar" value="Guardar" />
								</div>
								<div class="col-md-6">
									<a href="frmStatusEventosGrid.aspx" class ="btn btn-red btn-block" name ="btnCancelar" >Cancelar</a>
								</div>
							</div>
						</div>
