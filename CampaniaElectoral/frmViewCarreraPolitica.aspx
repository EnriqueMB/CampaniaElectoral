<%@ Page Language="C#" Title="Visualizar Carrera Politica" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmViewCarreraPolitica.aspx.cs" Inherits="CampaniaElectoral.WebForm3" %>
            ...
            <div class="col-md-12">
                <div class="panel panel-white">
                    ...
                    <div class="controls" style="padding-left:10px;">
                        <a href="frmCarreraPolitica.aspx" class="btn btn-green">Agregar <i class="fa fa-plus"></i></a>
                    </div>
                            ...
                            <% foreach (var Item in this.Lista)
                            {
                                string HTMLli = string.Format(@"<li class='col-md-3 col-sm-6 col-xs-12 mix category_1 gallery-img' data-cat='1'>
							                        <div class='portfolio-item'>
								                        <a class='thumb-info' href='Images/CarreraPolitica/{0}' data-lightbox='gallery' data-title='{1}'>
									                        <img src='Images/CarreraPolitica/{0}' class='img-responsive redim' alt='{2}'>
									                        <span class='thumb-info-title'> {1} </span>
								                        </a>
                                                        <div class='tools tools-bottom'>
														<a href='frmCarreraPolitica.aspx?op=2&id={3}'>
                                                    ...
                                                    <div class='modal-dialog modal-sm'>
		                                                <div class='modal-content'>
			                                                ...
			                                                <div class='modal-footer'>                     
                                                                ...
                                                                <a href='frmViewCarreraPolitica.aspx?op=3&id={3}' class='btn btn-green add-row' runat='server'>Si</a>
                                                            </div>
		                                                </div>
	                                                </div>
                                                </div>", Item.URLImagen, Item.Title, Item.Descripcion, Item.IDCarreraPolitica);
