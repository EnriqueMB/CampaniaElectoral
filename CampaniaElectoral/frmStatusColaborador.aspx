<%@ Page Language="C#" Title="Catálogo de status colaborador" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmStatusColaborador.aspx.cs" Inherits="CampaniaElectoral.frmStatusColaborado" %>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="input-icon">
                                    <input type="text" class="form-control tooltips" runat="server" id="txtDescripcion" name="txtDescripcion" placeholder="" maxlength="150" data-original-title="Ingrese un status de colaborador" data-rel="tooltip"  title="" data-placement="top" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <input type="submit" formaction="frmStatusColaborador.aspx" class="btn btn-green btn-block" name ="btnGuardar" value="Guardar" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="frmStatusColaboradorGrid.aspx" class ="btn btn-red btn-block" name ="btnCancelar" >Cancelar</a>
                                </div>
                            </div>
                        </div>
