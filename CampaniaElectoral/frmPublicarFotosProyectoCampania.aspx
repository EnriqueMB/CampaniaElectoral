<%@ Page Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmPublicarFotosProyectoCampania.aspx.cs" Inherits="CampaniaElectoral.WebForm6" %>
						...
						<% foreach (var Item in this.Lista)
							{
								string HTMLli = string.Format(@"<li class='col-md-3 col-sm-6 col-xs-12 mix category_1 gallery-img' data-cat='1'>
													<div class='portfolio-item'>
														...
														<div class='chkbox'>
														<a href='frmPublicarFotosProyectoCampania.aspx?op=2&id={3}'>															
														</a>
													...
													<div class='modal-dialog modal-sm'>
														<div class='modal-content'>
															...
															<div class='modal-footer'>                     
																...
																<a href='frmPublicarFotosProyectoCampania.aspx?op=3&id={3}&id2={4}' class='btn btn-green add-row' runat='server'>Si</a>
															</div>
														</div>
													</div>
												</div>", Item.NombreArchivo, Item.Title, Item.Alt, Item.IDFoto, Item.IDPElectoral);
