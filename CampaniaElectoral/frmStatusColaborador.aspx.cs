...
{
    public partial class frmStatusColaborado : System.Web.UI.Page
    {
                    ...
                    if (Request.QueryString["op"] == "2")
                    {
                        if (Request.QueryString["id"] != null)
                        {
                            ...
                            if (int.TryParse(Request.QueryString["id"].ToString(), out ID))
                            {
                                ...
                                RR_StatusColaborador DatosAux = new RR_StatusColaborador { Conexion = Comun.Conexion, IDColaborador = ID};
        ...
        private void CargarDatos(RR_StatusColaborador DatosAux)
        {
            try
            {
                //BasicCrypto BC = new BasicCrypto();
