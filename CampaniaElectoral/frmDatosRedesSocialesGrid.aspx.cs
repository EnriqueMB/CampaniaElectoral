...
{
    public partial class frmDatosRedesSocialesGrid : System.Web.UI.Page
    {
            ...
            try
            {
                if (Request.QueryString["op"] != null && Request.QueryString["op"] == "3")
                {
                    if (Request.QueryString["id"] != null)
                    {
                        ...
                        RR_DatosRedesSociales Datos = new RR_DatosRedesSociales { Conexion = Comun.Conexion, IDRedSocial = AuxID, IDUsuario = Comun.IDUsuario };
