    ...
    <div class="col-sm-12">
        <div class="panel panel-white">
            ...
            <div class="panel-body">
                <div class="row">
                    <asp:HiddenField ID="txtIDAlianza" runat="server"/>
                </div>
                <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
				                ...
				                <div class="fileupload fileupload-new" data-provides="fileupload">
					                <div class="fileupload-new thumbnail">
                                        <img src="assets/images/NoImage.png" alt="" id="Logo" runat="server" data-src =""/>
					                </div>                                            
                ...
                <div class="row">
                    ...
                    <div class="form-group">
		                <div class="col-md-6">
                            <input type="submit" formaction="frmPartidoPoliticoAlianzaEdit.aspx?id=<%= Request["id"] %>" class="btn btn-green btn-block" name ="btnGuardar" value="Guardar" />
                        </div>
                        <div class="col-md-6">
