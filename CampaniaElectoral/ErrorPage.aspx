<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ErrorPage.aspx.cs" Inherits="CampaniaElectoral.ErrorPage" %>
...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>Sistema Campaña Electoral</title>
		<!-- start: META -->
		<meta charset="utf-8" />
			...
			<div class="row">
				...
				<div class="col-sm-12 page-error animated shake">
					...
					<div class="error-details col-sm-6 col-sm-offset-3">
						<h3>¡Lo sentimos!</h3>
						<p>
							Ocurrí&oacute; un error.
							<br>
							Hemos notado que algo sali&oacute mal en el sistema.
							<br>
