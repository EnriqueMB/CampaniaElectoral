<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CampaniaElectoralEstadistica.Login" %>
<!DOCTYPE html>
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
					...
					<form name="Elecciones" class="form-login" method="post" action="Login.aspx" >
						...
						<fieldset>
							...
							<div class="form-actions">
								<label for="remember" class="checkbox-inline">
									<input type="checkbox"  class="grey remember" id="remember" name="remember" checked/>
				...
				<div class="box-forgot">
					<h3>¿Olvid&oacute; su contraseña?</h3>
					<p>
						...
						<fieldset>
							...
							<div class="form-actions">
								<a class="btn btn-light-grey go-back">
									<i class="fa fa-chevron-circle-left"></i> Iniciar sesi&oacute;n
								</a>
					...
					<!-- start: COPYRIGHT -->
					<div class="copyright">
						<%DateTime.Now.Year.ToString();%>&copy; Creativa Softline
					</div>
					<!-- end: COPYRIGHT -->
				</div>
				<!-- end: FORGOT BOX -->
